...
// func NewOutpointFromTxBytes(b [36]byte) (o *overlay.Outpoint) {
// 	o = &Outpoint{
...
// func (o *overlay.Outpoint) TxBytes() []byte {
// 	return binary.LittleEndian.AppendUint32(o.Txid.CloneBytes(), o.OutputIndex)
// }

// func NewOutpointFromBytes(b [36]byte) (o *overlay.Outpoint) {
// 	o = &Outpoint{
...
// func (o *overlay.Outpoint) Bytes() []byte {
// 	return binary.BigEndian.AppendUint32(util.ReverseBytes(o.Txid.CloneBytes()), o.OutputIndex)
// }

// func NewOutpointFromString(s string) (o *overlay.Outpoint, err error) {
// 	if len(s) < 66 {
...
// func (o *overlay.Outpoint) String() string {
...
// func (o *overlay.Outpoint) UnmarshalJSON(data []byte) error {
// 	var x string
...
// func (o *overlay.Outpoint) Scan(value interface{}) error {
