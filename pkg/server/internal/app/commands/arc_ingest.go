...
type ArcIngestHandler struct {
	provider         NewMerkleProofProvider // Provider for handling Merkle proofs
	requestBodyLimit int64                  // Limit for the size of the request body
	responseTimeout  time.Duration          // Timeout for processing requests
}
