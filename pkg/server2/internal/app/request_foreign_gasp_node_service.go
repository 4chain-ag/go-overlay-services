...
func NewRequestForeignGASPNodeService(provider RequestForeignGASPNodeProvider) (*RequestForeignGASPNodeService, error) {
	if provider == nil {
		return nil, NewRequestForeignGASPNodeNilProviderError()
	}
...
// NewRequestForeignGASPNodeNilProviderError returns an Error indicating that the provider is nil.
func NewRequestForeignGASPNodeNilProviderError() Error {
	return Error{
		errorType: ErrorTypeIncorrectInput,
		err:       "request foreign GASP node service provider cannot be nil",
