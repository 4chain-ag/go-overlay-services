...
// DefaultStartGASPSyncProviderMockExpectations provides default expectations for StartGASPSyncProviderMock,
// with no error and expecting the StartGASPSync method to be called.
var DefaultStartGASPSyncProviderMockExpectations = StartGASPSyncProviderMockExpectations{
	Error:             nil,
